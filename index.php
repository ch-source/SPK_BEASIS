...
<head>
  ...
  <title>SMA Negeri I Ende - Login</title>
              ...
              <div class="col-lg-12">
                <div class="login-form">
                  <div class="text-center">
                    <img src="img/logonn.png" style="width:230px; height: 200px;">
                    <h2 class="h4 text-gray-900 mb-4" style="margin-top: 20px;">SMA NEGERI 1 ENDE</h2>
                    <h6 class="h6 text-gray-900 mb-4" style="margin-top: 20px;">JL. Wirajaya, Onekore, Kec. Ende Tengah, Kab. Ende, NTT</h6>
                  </div>
                  <?php
                    if(isset($_GET['notif'])){
