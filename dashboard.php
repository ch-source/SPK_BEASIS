...
<head>
  ...
  <link href="img/lgg.png" rel="icon">
  <title>SMA Negeri I Ende - Dashboard</title>
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php?p=halaman_awal">
        <div class="sidebar-brand-icon">
          <img src="img/logonn.png" style="width: 130%; height: 150px" >
        </div>
        <div class="sidebar-brand-text mx-3">SMAN I ENDE</div>
      </a>
      ...
      <li class="nav-item">
       ...
       <li class="nav-item">
        <a class="nav-link" href="dashboard.php?p=data_testing">
      ...
      <li class="nav-item">
        <a class="nav-link" href="dashboard.php?p=laporan_hasil_klasifikasi">
          <i class="fas fa-fw fa-book-open"></i>
          <span>Laporan Hasil Klasifikasi</span>
        </a>
      </li>
    </ul>
    <!-- Sidebar -->
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>copyright &copy; <script> document.write(new Date().getFullYear()); </script> SMA Negeri I Ende
