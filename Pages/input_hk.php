          ...
          <div class="card-body">
            ...
            <table class="table align-items-center table-hover table-bordered" id="dataTableHover">
                ...
                <tbody>
                  ...
                  include "koneksi.php";
                  $no=1;
                  $query_user="SELECT * FROM tbl_testing WHERE status_testing=''";
                ...
                <tr>
                  ...
                  <label>
                    <input type="checkbox" name="id_testing[]" value="<?php echo $data_user['id_testing'];?>">
                  </label>
                </td>
                <td><?php echo $no;?></td>
      ...
      <script>
        function pilihsemua()
        {
            var daftarku = document.getElementsByName("id_testing[]");
