      ...
      <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h2 class="h4 mb-0 text-gray-800">Import Data Testing</h2>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Import Data Testing</li>
            </ol>
          </div>
           <div class="row mb-12">
          ...
          <form method="post" action="" enctype="multipart/form-data">
            ...
            <a href="dashboard.php?p=data_testing" class="btn btn-danger">
          ...
          if(isset($_POST['preview'])){
            ...
            if($ext == "xlsx"){
              ...
              foreach($sheet as $row){ // Lakukan perulangan dari data yang ada di excel
                ...
                $status_testing = $row['I']; // Ambil data alamat

                // Cek jika semua data tidak diisi
                if($nama == "" && $kelas == "" && $pekerjaan_ayah == "" && $pekerjaan_ibu == "" && $penghasilan_ayah == "" && $penghasilan_ibu == "" && $tanggungan == "" && $transportasi == "" && $status_testing == "")
                ...
                if($numrow > 1){
                  ...
                  $status_testing_td = ( ! empty($status_testing))? "" : " style='background: #E07171;'"; // Jika Alamat kosong, beri warna merah

                  // Jika salah satu data ada yang kosong

                  if($nama == "" or $kelas == "" or $pekerjaan_ayah == "" or $pekerjaan_ibu == "" or $penghasilan_ayah == "" or $penghasilan_ibu == "" or $tanggungan == "" or $transportasi == "" or $status_testing == ""){
                  ...
                  echo "<td".$status_testing_td.">".$status_testing."</td>";
                  echo "</tr>";
                }
